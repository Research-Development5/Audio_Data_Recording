...
if choose=='Record voice':
    ...
    with st.form("My form",clear_on_submit=True):
        ...
        if len(audio1) > 0:
        	...
        	wav_file = open("/home/amad/streamlit/voice recording (AADIL)/temp/sample.wav", "wb")
        ...
        if submitted:
           # record_state= st.text('recording...')
            ...
            path_myrecording = f"/home/amad/streamlit/voice recording (AADIL)/temp/sample.wav"
    ...
    if st.button("صوت سیو کیجیے"):
        if st.session_state["counter"] ==0:
            ...
            try:
                ...
                file_name='0'
            path_myrecording = f"/home/amad/streamlit/voice recording (AADIL)/recorded_voices/"+file_name+".wav"
            save_record(path_myrecording, st.session_state["rec"], 48000)
            os.remove('/home/amad/streamlit/voice recording (AADIL)/temp/sample.wav')
